...
if (window.MIDI) {
  ...
  return (function (e) {
          ...
          c = function (r) {
            ...
            if (!t.loaded[r.url]) {
              ...
              (d.onreadystatechange = function () {
                ...
                (d.onerror = function () {
                  if (
                    ((u = !0), delete t.loading[r.url], "object" === n(r.test))
                  )
            ...
            p = function A() {
              if ((f++, o[f])) {
                ...
                t.loading[r]
                  ...
                  ? A()
                  : (c(n), d(n));
              } else u ? e.error && e.error() : e.onsuccess && e.onsuccess();
            };
          p();
    ...
    function (e, t) {
      ...
      function n(e, t, n, r) {
        ...
        return (
            ...
            (o
              ...
              : d.addEventListener("progress", function (e) {
                  ...
                  if (e.lengthComputable) t = e.total;
                    ...
                    var n = parseInt(d.getResponseHeader("Content-Length-Raw"));
          ...
          (d.onreadystatechange = function (e) {
            if (4 === d.readyState)
              if (200 === d.status || 304 === d.status || 308 === d.status) {
                if (t) {
                  var r;
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.request = n);
    },
    function (e, t, n) {
      "use strict";
      function r(e) {
      ...
      (a["default"].GM = (function (e) {
        ...
        ~(function () {
          for (
            ...
            var o = ((r - 12) / 12) >> 0,
              i = n[r % 12] + o;
            (a["default"].keyToNote[i] = r), (a["default"].noteToKey[r] = i);
          }
        })();
    },
    function (e, t, n) {
                      ...
                      case "noteOff":
                        ...
                        (p = T.noteNumber - (e.MIDIOffset || 0)),
                          a.push({
                            event: T,
                            time: M,
                            source: i["default"].noteOff(x, T.noteNumber, I),
    ...
    function (e, t, n) {
      ...
      function o(e) {
        ...
        function n(e) {
          ...
          if (240 === (240 & n)) {
            ...
            switch (i) {
              case 0:
                if (((t.subtype = "sequenceNumber"), 2 !== u))
                  throw new Error(
                    "Expected length for sequenceNumber event is 2, got " + u
                  );
                return (t.number = e.readInt16()), t;
              case 1:
                return (t.subtype = "text"), (t.text = e.read(u)), t;
              case 2:
                return (t.subtype = "copyrightNotice"), (t.text = e.read(u)), t;
              case 3:
                return (t.subtype = "trackName"), (t.text = e.read(u)), t;
              case 4:
                return (t.subtype = "instrumentName"), (t.text = e.read(u)), t;
              case 5:
              ...
              case 32:
                if (((t.subtype = "midiChannelPrefix"), 1 !== u))
                  throw new Error(
                    "Expected length for midiChannelPrefix event is 1, got " + u
                  );
              ...
              case 81:
                ...
                return (
                  (t.microsecondsPerBeat =
                    (e.readInt8() << 16) + (e.readInt8() << 8) + e.readInt8()),
                  t
                );
              case 84:
            ...
            switch (((t.channel = 15 & n), (t.type = "channel"), l)) {
              ...
              case 12:
                return (t.subtype = "programChange"), (t.programNumber = c), t;
              case 13:
        ...
        for (
          ...
          var v = t(o);
          if ("MTrk" !== v.id)
            throw new Error("Unexpected chunk - expected MTrk, got " + v.id);
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }), (t.MidiFile = o);
      var a = n(12),
        i = r(a);
    },
    function (e, t) {
    ...
    function (e, t) {
      ...
      function n(e, t, n, r) {
        function a() {
          for (var t = null, n = null, r = null, o = 0; o < i.length; o++)
            null != i[o].ticksToNextEvent &&
              ...
              ((t = i[o].ticksToNextEvent), (n = o), (r = i[o].nextEventIndex));
          if (null != n) {
            var a = e.tracks[n][r];
            e.tracks[n][r + 1]
        ...
        for (
          var i = [], u = r || 120, s = !!r, c = e.header.ticksPerBeat, l = 0;
          l < e.tracks.length;
          l++
        )
          i[l] = {
          ...
          var c = function (e, t) {
              if (a["default"].channels[e]) {
                ...
                if ((t = u[t])) {
                  ...
                  if (((i[d] = l), !a["default"].Soundfont[c]))
                    return void (a["default"].DEBUG && console.log("404", c));
            ...
            l = function (e, t) {
              if (a["default"].channels[e]) {
                ...
                if ((t = u[t]))
                  for (var c = s + "" + t.id, l = 0, d = o.length; l < d; l++) {
                    var f = (l + r + 1) % d,
                      p = i[f];
                    if (p && p === c) return o[f].pause(), void (i[f] = null);
                  }
              }
            };
          (e.audioBuffers = o),
...
if (!result) throw Error("wrapper failed, file: midi.min.js name: MIDI")
console.log('wraplib midi.min.js MIDI', typeof window.MIDI)
